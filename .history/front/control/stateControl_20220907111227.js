...
const loadTable = async () => {
    ...
    users.forEach(element => {
        ...
        trHTML += `<td class="buttons"><button class="edit" onclick="confirmForm('${element.id}', this.innerHTML)">Edit</button>`;
        trHTML += `<button class="delete" onclick="confirmForm('${element.id}', this.innerHTML)">Del</button></td>`;
        trHTML += `</tr>`;
    });
