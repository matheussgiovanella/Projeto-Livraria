...
const editUserForm = async (id, password) => {
    ...
    Swal.fire({
        ...
        html:
            ...
            `<input id="sex" class="swal2-input" placeholder="Sex" value="${user.sex}">` +
            `<input id="age" class="swal2-input" placeholder="Age" value="${user.age}">` +
            `<input id="email" class="swal2-input" placeholder="Email" value="${user.email}">` +
            `<input id="password" class="swal2-input" placeholder="Password" value="${password}">` +
