...
const loadTable = async () => {
    ...
    cities.forEach(city => {
        ...
        trHTML += `<td class="buttons"><button class="edit" onclick="editStateForm('${city.id}')">Edit</button>`;
        trHTML += `<button class="delete" onclick="confirmStateForm('${city.id}')">Del</button></td>`;
        trHTML += `</tr>`;
    });
