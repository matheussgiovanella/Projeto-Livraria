...
const editStateForm = async (id) => {
    ...
    Swal.fire({
        ...
        html:
            ...
            `<input id="province" class="swal2-input" maxlength="2" placeholder="Province" value="${state.province}">`,
        focusConfirm: false,
        showCancelButton: true,
        preConfirm: async () => {
...
const deleteState = async (id) => {
    const state = await axios.getState(`${ENDPOINT}/states/${id}`);
