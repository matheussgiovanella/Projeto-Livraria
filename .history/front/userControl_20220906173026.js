...
const loadTable = async () => {
    ...
    users.forEach(element => {
        ...
        trHTML += `<td class="buttons"><button class="edit-button" onclick="confirmUserForm('${element.id}', this.innerHTML)">Edit</button>`;
        trHTML += `<button class="delete-button" onclick="confirmUserForm('${element.id}', this.innerHTML)">Del</button></td>`;
        trHTML += `</tr>`;
    });
    trHTML += `<tr>`;
    trHTML += `<td>${element.id}</td>`;
    ...
    trHTML += `<td>${element.age}</td>`;
    trHTML += `<td>${element.email}</td>`;
    trHTML += `<td class="buttons">`;
    trHTML += `<button class="create-button" onclick="confirmUserForm('${element.id}', this.innerHTML)">Del</button>`;
    trHTML += `</td>`;
    trHTML += `</tr>`;
